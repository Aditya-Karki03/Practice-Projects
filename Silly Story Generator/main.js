...
const customName = document.getElementById('cust');
const randomize = document.querySelector('.generator');
...
const insertX =['insertWilly the Goblin', 'Big Daddy', 'Father Christmas'];
